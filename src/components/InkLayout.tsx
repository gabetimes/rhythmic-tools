...
const navItems = [
  { to: "/ink", icon: Home, label: "Today" },
  { to: "/ink/exercises", icon: Compass, label: "Journeys" },
  { to: "/ink/spaces", icon: Camera, label: "Spaces" },
  { to: "/ink/stats", icon: BarChart3, label: "Practice" },
];
