  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 font-sans text-muted-foreground leading-relaxed">
      <h1 className="text-4xl font-serif font-semibold text-foreground tracking-tight mb-2">
        Terms of Services &mdash; Rhythmic Tools
      </h1>
      ...
      <p className="mb-4">
        We operate Rhythmic tools available at{" "}
        <a
        ...
        (the &ldquo;Website&rdquo;), Rhythmic apps available in the Apple App
        Store and Google Play Store (the &ldquo;Applications&rdquo;), and any
      ...
      <p className="mb-4">
        ...
        , or by mail to 251 Little Falls Drive, Wilmington, DE 19808.
      </p>
      <p className="mb-4">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (&ldquo;you&rdquo;),
        and Rhythmic, Inc., concerning your access to and use of the Services.
      ...
      <p className="mb-4">
        ...
        you about any changes by updating the &ldquo;Last updated&rdquo; date of
      ...
      <ol className="list-decimal pl-6 mb-8 space-y-1">
        ...
        <li>ILLINOIS USERS AND RESIDENTS</li>
        <li>MISCELLANEOUS</li>
        <li>CONTACT US</li>
      </ol>
      ...
      <p className="mb-4">
        ...
        (&ldquo;Contributions&rdquo;). Any Submission that is publicly posted
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          ...
          ACTIVITIES&rdquo; and will not post, send, publish, upload, or transmit
      ...
      <p className="mb-4">
        ...
        any illegal or unauthorized purpose; and (7) your use of the Services
      ...
      <p className="mb-4">
        We accept payments through Apple In-App Purchases, Google Play In-App
        Purchases, and such other payment methods as we may make available
        through the Services from time to time. All payment processing is subject
        to the terms and conditions of the applicable third-party payment
        processor.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        We offer a 7-day free trial to new users who register with the Services.
        By starting a free trial, you acknowledge and agree that, unless you
        cancel before the end of the trial period, your subscription will
        automatically convert to a paid subscription and your chosen payment
        method will be charged at the then-current subscription rate. We will
        send you a reminder before your trial expires. You may cancel your free
        trial at any time through your account settings or through the applicable
        App Distributor (Apple App Store or Google Play) before the trial period
      ...
      <p className="mb-4">
        If you subscribed via the website, you may cancel in your account
        settings. If you subscribed via the Apple App Store or Google Play Store,
        you must cancel through your device&rsquo;s subscription management
        settings. We cannot cancel third-party store subscriptions on your
        behalf. Your cancellation will take effect at the end of the current paid
      ...
      <p className="mb-6">
        Subscriptions purchased through the Apple App Store or Google Play Store
        are subject to the refund policies of those platforms. To request a
        refund, please contact Apple or Google directly through their standard
        refund process. For purchases made directly through our website (if
        applicable), all sales are final unless otherwise required by applicable
        law.
      </p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        ...
        <li>
          ...
          formats (&ldquo;gifs&rdquo;), 1x1 pixels, web bugs, cookies, or other
          similar devices (sometimes referred to as &ldquo;spyware&rdquo; or
      ...
      <p className="mb-4">
        By posting Contributions to any part of the Services, you grant us a
        non-exclusive, royalty-free, worldwide license to use, copy, store,
        display, and distribute such Contributions solely as necessary to
        operate, provide, and improve the Services. This includes the right to:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          Display your Contributions within the Services (for example, if you
          participate in community features)
        </li>
        <li>
          Store and back up your Contributions as part of normal service
          operations
        </li>
        <li>
          Analyze aggregated and de-identified Contributions to improve our
          products
        </li>
        <li>
          Moderate, edit, or remove Contributions that violate these Legal Terms
        </li>
      </ul>
      <p className="mb-4">
        We will not use your Contributions for advertising, marketing, or
        promotional purposes without your separate, explicit consent. You retain
        full ownership of your Contributions and any intellectual property rights
        associated with them. We do not claim ownership over your personal
        reflections, journal entries, or other content you create within the
        Services.
      </p>
      <p className="mb-6">
        You represent and warrant that you own or have the necessary rights to
        your Contributions and that they do not violate any third party&rsquo;s
        rights or any applicable law. We reserve the right to remove or disable
        access to any Contributions at any time, without notice, if we believe
        they violate these Legal Terms or applicable law.
      </p>
      ...
      <p className="mb-4">
        If you access the Services via an App, then we grant you a revocable,
      ...
      <p className="mb-6">
        The following terms apply when you use an App obtained from either the
        ...
        the App; (3) in the event of any failure of the App to conform to any
        ...
        government as a &ldquo;terrorist supporting&rdquo; country and (ii) you
      ...
      <p className="mb-4">
        ...
        Arbitration Association (&ldquo;AAA&rdquo;) and, where appropriate, the
        AAA&rsquo;s Supplementary Procedures for Consumer Related Disputes
        (&ldquo;AAA Consumer Rules&rdquo;), both of which are available at the
        ...
        in Wilmington, Delaware. Except as otherwise provided herein, the
      ...
      <p className="mb-4">
        ...
        courts located in Wilmington, Delaware, and the Parties hereby consent
      ...
      <p className="mb-4">
        ...
        such Dispute shall be decided by a court of competent jurisdiction within
      ...
      <p className="mb-6">
        ...
        above provisions concerning binding arbitration: (a) any Disputes seeking
      ...
      <p className="mb-4">
        <strong>AI-Generated Content.</strong> Responses from the AI Coach are
        generated using third-party artificial intelligence services. We do not
        use the content of your conversations to train our AI models. AI-generated
        responses may be inaccurate, incomplete, or unsuitable for your specific
        situation and should not be relied upon as professional advice.
      </p>
      <p className="mb-4">
        The AI Coach may inadvertently generate incorrect information,
        &ldquo;hallucinations,&rdquo; or offensive statements.
      </p>
      <p className="mb-4">
        <strong>NO MEDICAL OR MENTAL-HEALTH ADVICE.</strong> All information,
        guidance, and other content made available through the Services, including
        responses generated by any AI-powered chatbot, are provided for general
        educational and informational purposes only and are not a substitute for
        professional medical, mental-health, legal, or other professional advice,
        diagnosis, or treatment. Rhythmic, Inc. is not a licensed medical or
        healthcare provider and does not furnish medical services.
      </p>
      <p className="mb-4">
        The AI Chatbot may produce responses that are imprecise, incomplete,
        outdated, or otherwise unreliable, and should not be relied upon as
        factually correct or comprehensive. No provider-patient or
        therapist-client relationship is created by your use of the Services or
        the AI Chatbot. Always seek the advice of a qualified professional with
        any questions you may have regarding a medical condition, your mental
        health, or any other matter requiring professional expertise.
      </p>
      <p className="mb-4">
        The Services are intended solely for day-to-day stress management and
        general well-being. They do not diagnose, prevent, monitor, treat, or
        alleviate any mental-health disorder and therefore are not classified as,
        nor intended to be, a medical device under applicable U.S. FDA, EU MDR,
        or UK MHRA regulations.
      </p>
      <p className="mb-4">
        If you are in crisis, think you may harm yourself or others, or believe
        you are experiencing a psychiatric or medical emergency, call your local
        emergency number immediately (for example, dial 911 in the U.S., 112 in
        the EU) or contact your nearest crisis hotline.
      </p>
      <p className="mb-4">
        Your reliance on any information provided via the Services is solely at
        your own risk, and Rhythmic, Inc. expressly disclaims any responsibility
        or liability for any injury, loss, or damage arising out of or relating
        to your use of, or reliance upon, such information. Outcomes vary between
        individuals, and we make no guarantees of any particular result.
      </p>
      <p className="mb-6">
      ...
      {/* 25. ILLINOIS USERS AND RESIDENTS */}
      <h2 className="text-2xl font-serif font-semibold text-foreground mt-10 mb-4">
        25. ILLINOIS USERS AND RESIDENTS
      </h2>
      <p className="mb-6">
        Rhythmic Tools is a general wellness tool for stress management and is
        not therapy, psychotherapy, or a substitute for licensed mental health
        services. The Services are not offered for therapeutic use to individuals
        located in Illinois, and by accessing the Services, you represent that
        you are not using Rhythmic Tools as a replacement for professional mental
        health treatment. If you are an Illinois resident seeking therapy or
        counseling, please consult a licensed behavioral health professional.
      </p>
